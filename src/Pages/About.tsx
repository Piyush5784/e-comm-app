              ...
              <div className="row justify-content-xl-center">
                <div className="col-12 col-xl-11">
                  ...
                  <p className="lead fs-4 text-secondary mb-3">
                    Piyush is a full stack developer guy who uses the lastest
                    MERN technologies to build websites.
                  </p>
                  <p className="mb-5">
                    He is a dedicated developer having expertise in the MERN
                    stack, Bootstrap, Tailwind, TypeScript, and Firebase, to
                    deliever, high-quality, scalable websites.
                  </p>
                      ...
                      <div className="d-flex">
                        ...
                        <div>
                          ...
                          <p className="text-secondary mb-0">
                            He is crafting a digital method that subsists life
                            across all mediums.
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="col-12 col-md-6">
                      <div className="d-flex">
                        ...
                        <div>
                          ...
                          <p className="text-secondary mb-0">
                            He believes in innovation by merging primary with
                            elaborate ideas.
                          </p>
                        </div>
                      </div>
