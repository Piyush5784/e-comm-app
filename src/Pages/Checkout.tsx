...
const Checkout = () => {
    ...
    const getAmt = cart.totalAmt;

    const discount = Math.floor(10 / 100 * cart.totalAmt);
            ...
            <div className="row">
                <div className="col-md-4 order-md-2 mb-4">
                    ...
                    <ul className="list-group mb-3">
                        ...
                        <Button className="w-100% m-3" onClick={() => purchaseHandler()}>Proceed to payment</Button>
                    </ul>
                </div>
                <div className="col-md-8 order-md-1">
                    <h4 className="mb-3">Billing address</h4>
                    <div className="address border rounded" >
                        <input id="address" type="radio" className="m-2 p-2 custom-control-input" onChange={(e) => setCheckbox(e.target.checked)} required />
                        <label className="custom-control-label p-2" htmlFor="credit" > Address 1</label>
